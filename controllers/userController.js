...
//   const user = await Persons.find({ gender: "female", eyeColor: "green" });
//   const user = await Persons.find({ eyeColor: { $eq: "green" } });
//   const user = await Persons.find({ eyeColor: { $eq: "green" } }).count();
//   const user = await Persons.find({
//     $and: [{ gender: "female" }, { favoriteFruit: "banana" }],
//     // for same fields
//   });
//   const user = await Persons.find({
//     $or: [{ gender: "female" }, { favoriteFruit: "banana" }],
//     // for same fields
//   });
